...
class ControladorAnimal():
    ...
    def abre_tela(self):
        lista_opcoes = {1: self.incluir_cachorro(self.__tela_animal.dados_cachorro), 2: self.incluir_gato(self.__tela_animal.dados_gato), 3: self.alterar_animal, 4: self.excluir_animal, 5: self.mostra_animal, 6: self.listar_animais, 7: self.listar_cachorros, 8: self.listar_gatos}
